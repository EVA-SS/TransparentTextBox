...
namespace TSkin.ST
{
    public class GraphemeSplitter : TextBoundary
    {
        ...
        protected override bool ShouldBreak(int nRightType, List<int> lstHistoryBreakType)
        {
        ...
        protected override int GetBreakProperty(int nCodePoint)
        {
            ...
            return TextBoundary.BinarySearchRangeFromList(0, m_lst_code_range.Count - 1, nCodePoint, m_lst_code_range);
        }
    }
}
