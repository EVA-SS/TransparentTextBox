...
namespace TSkin.ST
{
    partial class STTextBox
    {
        public class Core
        {
            ...
            public Rectangle ViewRectangle { get; internal set; }
            ...
            internal Core(STTextBox textBox)
            {
                ...
                this.ITextView = new SingleTextView();
            ...
            public TextStyle GetStyleFromCharIndex(int nIndex)
            {
                ...
                if (this.ITextStyleMonitors == null || this.ITextStyleMonitors.Length == 0)
                {
                    style.ForeColor = this.TextBox.ForeColor;
                    return style;
                }
        ...
        [Description("设置文本模式"), Category("外观"), DefaultValue(null)]
        public ITextView SetTextView
        {
            get => m_core.ITextView;
            set
            {
                if (value == null || m_core.ITextView == value)
                {
                    return;
                }
                m_core.ITextView = value;
                value.Init(m_core);
            }
        }
